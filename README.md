...
`generated_master_plan.json`:
    *   **Description:** A JSON file containing the high-level plans generated by the LLM for each grammar rule in `grammar_rules.txt`. These plans guide how visitor methods should be implemented in the next step.
