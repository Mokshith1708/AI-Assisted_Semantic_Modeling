...
class CobolZ3Visitor:
    ...
    def visit_DataValueIntervalTo(self, node: ASTNode):
    ...
    def visit_MoveCorrespondingToStatement(self, node: ASTNode):
    ...
    def visit_RelationCombinedCondition(self, node: ASTNode):
        children = _get_children(node)
        if not children:
    ...
    def visit_Abbreviation(self, node: ASTNode, previous_lhs_expr, previous_op_func):
    ...
    def visit_TableCall(self, node: ASTNode):
